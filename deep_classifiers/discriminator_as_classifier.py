...
# For example "./$ python discriminator_as_classifier 3 4" means we are creating the model on subject 3; Training on -: session 1,2,3,5 and test on session 4
